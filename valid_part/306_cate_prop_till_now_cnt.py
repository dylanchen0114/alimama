...
train = pd.read_pickle('../processed/train_valid/train_id_processed.p')[['instance_id', 'context_date']]
test = pd.read_pickle('../processed/train_valid/test_id_processed.p')[['instance_id', 'context_date']]
...
concat_category = concat.merge(concat_category, how='left', on='instance_id')
concat_property = concat.merge(concat_property, how='left', on='instance_id')
...
concat_category.to_pickle('../features/train_valid/concat_cate_till_now_cnt_feature_306.p')
concat_property.to_pickle('../features/train_valid/concat_prop_till_now_cnt_feature_306.p')
