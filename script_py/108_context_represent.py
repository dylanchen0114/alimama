...
# saving
train_feats.drop(['context_timestamp', 'user_id'], axis=1).to_pickle('../features/train_feature_108.p')
test_feats.drop(['context_timestamp', 'user_id'], axis=1).to_pickle('../features/test_feature_108.p')
