...
concat_category.to_pickle('../features/train_test/concat_cate_till_now_cnt_feature_306.p')
concat_property.to_pickle('../features/train_test/concat_prop_till_now_cnt_feature_306.p')
