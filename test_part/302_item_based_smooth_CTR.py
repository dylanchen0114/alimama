...
train[['instance_id'] + feature_columns].\
    to_pickle('../features/train_test/train_feature_302.p')
test[['instance_id'] + feature_columns].\
    to_pickle('../features/train_test/test_feature_302.p')
