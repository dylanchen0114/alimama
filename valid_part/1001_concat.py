...
# concat features
train_feats = read_pickles('../features/train_valid/train_feature_*.p', 'instance_id').reset_index()
test_feats = read_pickles('../features/train_valid/test_feature_*.p', 'instance_id').reset_index()


# feature 303
tmp_feat = pd.read_pickle('../features/train_valid/concat_category_feature_303.p').reset_index()
...
tmp_feat = pd.read_pickle('../features/train_valid/concat_cate_till_now_cnt_feature_306.p')
...
tmp_feat = pd.read_pickle('../features/train_valid/concat_prop_till_now_cnt_feature_306.p')
...
tmp_feat = pd.read_pickle('../features/train_valid/concat_cate_smt_ctr_feature_304.p')
...
tmp_feat = pd.read_pickle('../features/train_valid/concat_prop_smt_ctr_feature_304.p')
...
# saving
to_pickles(df=train_feats, path='../features/all/train_valid/train/', split_size=5)
to_pickles(df=test_feats, path='../features/all/train_valid/test/')
