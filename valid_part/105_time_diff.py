...
train_feat[['instance_id', 'time_diff_last_query']].\
    to_pickle('../features/train_valid/train_feature_105.p')
test_feat[['instance_id', 'time_diff_last_query']].\
    to_pickle('../features/train_valid/test_feature_105.p')
