...
train[['instance_id'] + feature_columns].to_pickle('../features/train_valid/train_feature_302.p')
test[['instance_id'] + feature_columns].to_pickle('../features/train_valid/test_feature_302.p')
