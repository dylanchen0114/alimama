...
train_feat[['instance_id', 'time_diff_last_expose_this_cate']].\
    to_pickle('../features/train_valid/train_feature_502.p')
test_feat[['instance_id', 'time_diff_last_expose_this_cate']].\
    to_pickle('../features/train_valid/test_feature_502.p')
