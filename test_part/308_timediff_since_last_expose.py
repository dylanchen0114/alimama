...
#
# col = ['instance_id', 'item_id', 'context_timestamp']
# concat = train[col].append(test[col])
#
# concat.sort_values(['item_id', 'context_timestamp'], inplace=True)
#
# concat['t-1_context_timestamp'] = concat.groupby('item_id')['context_timestamp'].shift(1)
#
# concat['time_diff_item_last_expose'] = np.log1p(concat['context_timestamp'] - concat['t-1_context_timestamp'])
#
#
...
#
#
# train_feat[['instance_id', 'time_diff_item_last_expose']].to_pickle('../features/train_feature_308.p')
# test_feat[['instance_id', 'time_diff_item_last_expose']].to_pickle('../features/test_feature_308.p')
