...
cnt_cols = ['instance_id', 'item_brand_id', 'user_id', 'shop_id']
...
tmp_category = concat[cnt_cols + stat_cols].merge(concat_category, how='left', on='instance_id')
...
result1.to_pickle('../features/train_valid/concat_category_feature_303.p')
result2.to_pickle('../features/train_valid/concat_property_feature_303.p')
